...
test: check-git install-tool-deps
	...
	# Timeout increased downstream in https://github.com/openshift/thanos/pull/144
	@go test $(SHORT) -tags slicelabels -race -timeout 25m $(shell go list ./... | grep -v /vendor/ | grep -v /test/e2e);
